...
BOARD_SUPER_PARTITION_SIZE := 9126805504 # RODO: Fix hardcoded value.
BOARD_SUPER_PARTITION_SYSTEM_DEVICE_SIZE := 3087618048 # RODO: Fix hardcoded value.
BOARD_SUPER_PARTITION_GROUPS := main
BOARD_MAIN_PARTITION_LIST := system vendor product 
BOARD_MAIN_SIZE := 9122611200 # RODO: Fix hardcoded value.
BOARD_ROOT_EXTRA_FOLDERS := bluetooth dsp firmware persist

# Platform
TARGET_BOARD_PLATFORM := bengal # RODO: Fix hardcoded value.
